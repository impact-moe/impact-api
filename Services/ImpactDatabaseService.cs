...
namespace ImpactApi.Services
{
    public class ImpactDatabaseService
    {
        ...
        public async Task<List<Constellation>> GetConstellations(string characterId)
        {
            ...
            string command = "SELECT * FROM ImpactDB.ConstellationTable ORDER BY ConstellationTable.order ASC WHERE (character_id = @character_id)";
        ...
        public async Task<List<ArtifactPriority>> GetArtifactPriorities(string characterId, bool details)
        {
            ...
            string command = "SELECT * FROM ImpactDB.ArtifactPriorityTable ORDER BY ArtifactPriorityTable.rank ASC WHERE character_id = @character_id";
        ...
        public async Task<List<WeaponPriority>> GetWeaponPriorities(string characterId, bool details)
        {
            ...
            string command = "SELECT * FROM ImpactDB.WeaponPriorityTable ORDER BY WeaponPriorityTable.rank ASC WHERE character_id = @character_id";
        ...
        public async Task<List<SubStatPriority>> GetSubStatPriorities(string characterId)
        {
            ...
            string command = "SELECT * FROM ImpactDB.SubStatPriorityTable ORDER BY SubStatPriorityTable.rank ASC WHERE character_id = @character_id";
